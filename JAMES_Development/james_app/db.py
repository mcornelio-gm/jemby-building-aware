        ...
        demo_assets = [
            {
                ...
                "is_panel": 0, "slots": 0, "survey_sequence": 1, "attributes": {"service_mva": 250.0}
            },
            {
                ...
                "fed_from": None, "voltage": "480Y/277V", "amps": 1128.0, "aic": 35.0,
                "is_panel": 0, "slots": 0, "survey_sequence": 2, "attributes": {"kw": 750.0, "kva": 937.5}
            },
            {
                ...
                "fed_from": "UTIL-1", "voltage": "480Y/277V", "amps": 400.0, "aic": 65.0,
                "is_panel": 0, "slots": 0, "survey_sequence": 3, 
                "attributes": {
            ...
            },
            {
                ...
                "type_name": "Main Distribution Panel (MDP)", "room": "Level 1 - Main Electric Room 101",
            ...
            },
            {
                ...
                "fed_from": "MDP-1", "voltage": "480V : 208Y/120V", "amps": 208.0, "aic": 22.0,
                "is_panel": 0, "slots": 0, "survey_sequence": 5, "attributes": {"kva": 75.0, "prim_v": 480.0, "sec_v": 208.0}
            },
            {
                "id": "s6", "tag": "LP-1A", "name": "Floor 1 Lighting & Receptacle Panel",
                "object_class": "LightingBranchPanelObject", "domain": "panels", "type_tag": "LP",
                "type_name": "Lighting Branch Panel", "room": "Level 1 - Electrical Closet 102",
                "fed_from": "T-1", "voltage": "208Y/120V 3Ø 4W", "amps": 225.0, "aic": 22.0,
                "is_panel": 1, "slots": 42, "survey_sequence": 6, "attributes": {"bus_rating_a": 225.0}
            },
            {
            ...
            },
            {
                ...
                "type_name": "Packaged Chiller / RTU", "room": "Penthouse - Mechanical Room",
                "fed_from": "MCC-1", "voltage": "480V 3Ø", "amps": 285.0, "aic": 65.0,
                "is_panel": 0, "slots": 0, "survey_sequence": 8, "attributes": {"mca": 285.0, "mocp": 400.0}
            },
            {
                "id": "s9", "tag": "UPS-1", "name": "250 kVA Data Center UPS",
                ...
                "is_panel": 0, "slots": 0, "survey_sequence": 9, "attributes": {"kva": 250.0, "kw": 250.0}
            },
        ]
